...
export default function Home({ yml, json }: { yml: string; json: string }) {
  return (
    <Meta
      title="fuadnafiz98 | Md. Muhtasim Fuad"
      ...
      <div className="relative">
        ...
        <div className="absolute z-50 -mt-24 md:bottom-0">
          <div>
            ...
            <h1 className="text-3xl font-black sm:text-4xl md:text-5xl lg:text-6xl">Minimalist,</h1>
            <h1 className="text-3xl font-black md:text-4xl lg:text-6xl">Backend Developer.</h1>
          </div>
        </div>
